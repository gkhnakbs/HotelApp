...
public class DbConnection extends Abstract1 implements Interface1 {
    ...
    Connection connection = null, connection1 = null, connection2 = null;
    ...
    public void getRequest() {
        ...
        try {
            connection = DbHelper.getConnection();// db bağlantısı için gerekli
            statement = connection.createStatement();// resultSeti nesneye aktarmak için kullanıyoruz
            resultSet = statement.executeQuery("SELECT * FROM technicalsupport ");  // resultSeti nesneye aktarmak için kullanıyoruz
    ...
    public void getHousekeepingRequest() {
        ...
        try {
            connection = DbHelper.getConnection();// db bağlantısı için gerekli
            statement = connection.createStatement();// resultSeti nesneye aktarmak için kullanıyoruz
            resultSet = statement.executeQuery("SELECT * FROM housekeeping");  // resultSeti nesneye aktarmak için kullanıyoruz
    ...
    public void getOrders() {
        ...
        try {
            connection = DbHelper.getConnection();// db bağlantısı için gerekli
            statement = connection.createStatement();// resultSeti nesneye aktarmak için kullanıyoruz
            resultSet = statement.executeQuery("SELECT order_name,order_roomnumber,order_status,id FROM hotelsdb.orders ");  // resultSeti nesneye aktarmak için kullanıyoruz
            int i = 0;
            while (resultSet.next()) {
    ...
    public void updateRoomStatus(int room_status, int room_number,int room_spendamount) {
        ...
        try {
            ...
            connection = DbHelper.getConnection();// db bağlantısı için gerekli
            statement = connection.prepareStatement("UPDATE rooms SET room_status=" + room_status + ",room_spendamount="+room_spendamount+" WHERE room_number=" + room_number);// resultSeti nesneye aktarmak için kullanıyoruz
            statement.executeUpdate();
    ...
    public void updateHousekeepingStatus(int housekeeping_status, int id) {
        ...
        try {
            ...
            connection = DbHelper.getConnection();// db bağlantısı için gerekli
            statement = connection.prepareStatement("UPDATE housekeeping SET housekeeping_status=" + housekeeping_status + " WHERE id=" + id);// resultSeti nesneye aktarmak için kullanıyoruz
            statement.executeUpdate();
            System.out.println("Güncellendi.");
    ...
    public void updateCustomer(String  customerID) {
        ...
        try {
            ...
            connection = DbHelper.getConnection();// db bağlantısı için gerekli
            statement = connection.prepareStatement("UPDATE customers SET customer_roomnumber=" + 0 +",customer_uniqueID='0' WHERE customer_uniqueID='" + customerID+"'");// resultSeti nesneye aktarmak için kullanıyoruz
            statement.executeUpdate();
            System.out.println("Güncellendi.");
    ...
    public void housekeepingAdding(String time) {
        ...
        // resultSeti nesneye aktarmak için kullanıyoruz
        try {
